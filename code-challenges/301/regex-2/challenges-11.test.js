...
// I know this works but jest keeps flipping the requirement when I pass it a truthy or falsy. Is it possible this is an error? I spoke to some peers and they experienced the same
...
const regex4 = /[0-9]{3}-[0-9]{7}/;
const regex5 = /[0-9]{3}-[0-9]{3} [0-9]{4}/;
const regex6 = /[0-9]{3}-[0-9]{3}-[0-9]{4}/;
const regex7 = /[0-9]{3} [0-9]{3} [0-9]{4}/;
const regex8 = /[0-9]{6}-[0-9]{4}/;
const regex9 = /[0-9]{10}/;

const validatePhoneNumber = (phoneNumber) => {
  if (phoneNumber !== regex1 || regex2 || regex3 || regex4 || regex5 || regex6 || regex7 || regex8 || regex9) {
    return false;
  } else {
    return true;
  }
